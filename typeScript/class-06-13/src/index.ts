...
//     return x + y;
//   }
//   else if (typeof x === 'string' && typeof y === 'string' && typeof z === 'string') {
//     return x.toUpperCase() + " " + y.toLowerCase() + " " + z.toUpperCase()
//   } else {
...
// console.log(add(5,8));
// console.log(add('ruhama','gull','malik'));
